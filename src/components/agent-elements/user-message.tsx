    ...
    <div className={cn("flex flex-col items-end gap-1", className)}>
      ...
      {text && (
        <div className="ms-[70px] max-w-[calc(95%-40px)]">
          <div className="rounded-an-message bg-an-user-message-bg px-3.5 py-1.5 text-an-user-message-text text-sm transition-colors">
            <p className="wrap-break-word whitespace-pre-wrap leading-5">
              {text}
            </p>
          </div>
        </div>
