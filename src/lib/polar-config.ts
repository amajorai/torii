...
export const POLAR_CONFIG = {
  ...
  /**
   * Checkout URL, optionally with a discount code pre-applied
   * Set VITE_POLAR_DISCOUNT_CODE to append ?discount_code=... automatically
   */
  checkoutUrl: import.meta.env.VITE_POLAR_DISCOUNT_CODE
    ? `${import.meta.env.VITE_POLAR_PURCHASE_URL || "https://polar.sh"}${(import.meta.env.VITE_POLAR_PURCHASE_URL || "https://polar.sh").includes("?") ? "&" : "?"}discount_code=${import.meta.env.VITE_POLAR_DISCOUNT_CODE}`
    : import.meta.env.VITE_POLAR_PURCHASE_URL || "https://polar.sh",
